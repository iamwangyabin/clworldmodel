...
A chunk whose old encoder trace has only float32-level centered temporal feature
energy has no meaningful geometry for CKA or Procrustes to compare. Those chunks are excluded
